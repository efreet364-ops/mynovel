...
public class WriterTutorialApp {
    ...
    @Resource
    private Advisor writerTutorialAppRagCloudAdvisor;
    ...
    public WriterTutorialApp(ChatModel dashScopeChatModel, ChatMemory chatMemory) {
    ...
    public String doChatWithRag(String message, String chatId) {
        ChatResponse chatResponse = chatclient.prompt()
                .user(message)
                .advisors(MessageChatMemoryAdvisor.builder(chatMemory).conversationId(chatId).build())
                .advisors(writerTutorialAppRagCloudAdvisor)
                .call()
                .chatResponse();
